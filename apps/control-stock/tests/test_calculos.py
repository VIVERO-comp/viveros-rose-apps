...
def test_precio_online_formatea_el_precio_de_odoo():
    assert calculos.precio_online(350) == "$3.50"
    assert calculos.precio_online(1500) == "$15.00"


def test_precio_online_sin_precio_en_odoo_es_none():
    ...
    assert calculos.precio_online(None) is None
